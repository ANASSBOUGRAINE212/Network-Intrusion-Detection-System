...
```bash
# Check files exist
ls src/models/deep\ learning/best_dl_model_wide_and_deep.keras
ls scaler-features/dl_scaler.pkl
...
- Minute must be 0-59
- Second must be 0-59
- All flag counts must be 0 or 1
...
**Model Optimization:**
- Model size: ~1.8 MB (efficient)
- Inference time: ~10ms per prediction
- Batch predictions supported
- GPU acceleration available (TensorFlow)
...
- Additional chart types (bar, line, radar)
...
### Dark Theme Design
- **Color Palette:**
  - Background: Navy Blue (#2C3E50, #34495E)
  - Accents: Yellow/Gold (#F39C12, #FDB813)
  - Text: White (#FFFFFF) and Light Gray (#ECF0F1)
  
- **Visual Elements:**
  - Decorative circular gradients with yellow glow
  - Transparent sections with left accent borders
  - No white boxes - seamless dark background
  - Smooth hover animations
  - Glass-morphism navigation bar

### Interactive Visualizations
- **Pie Charts (Chart.js):**
  - Main Model: 12 unique vibrant colors
  - Rare Model: 12 unique coral/turquoise/mint colors
  - Custom legends with color-coded labels
  - Hover tooltips with dark theme
  - Responsive sizing

- **Chart Images:**
  - Inverted colors for dark background compatibility
...
**Built with:** Python, Flask, TensorFlow, HTML5, CSS3, JavaScript, Chart.js  
**Dataset:** CICIDS2017 (200,000 samples)  
**Model:** Wide & Deep Neural Network + Ensemble System  
**Performance:** 99.28% F1-Score, 98.11% Accuracy  
**Features:** 65 network traffic features  
**Classes:** 15 (1 benign + 14 attack types)  
**UI Theme:** Modern Dark Navy with Yellow Accents
